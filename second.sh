...
#Code for 1st STAR run, needs to be run on something with lots of RAM and speed: STAR --runThreadN 12 --runMode genomeGenerate --genomeDir hg19_index --genomeFastaFiles hg19.fa --sjdbGTFfile hg19.GTF --sjdbOverhang 74 --genomeSAsparseD 4
...
#Enter the FULL path here to prevent STAR throwing a wobbly
